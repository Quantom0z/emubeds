...
<head>
    ...
    <title>GBA.js</title>
    <link rel="stylesheet" href="https://endrift.github.io/gbajs/resources/main.css">
    <script>Object.prototype.inherit = function() {
        for (var v in this) {
            this[v] = this[v];
        }
    };</script>
    <script>function ARMCore() {
        this.inherit();
        this.SP = 13;
        this.LR = 14;
        this.PC = 15;
    ...
    <script>ARMCoreArm = function (cpu) {
        this.cpu = cpu;
    ...
    <script>function MemoryView(memory, offset) {
        this.inherit();
        this.buffer = memory;
    ...
    <script>function GameBoyAdvanceIO() {
        // Video
        this.DISPCNT = 0x000;
        this.GREENSWP = 0x002;
        this.DISPSTAT = 0x004;
    ...
    <script>function GameBoyAdvanceAudio() {
    ...
    <script>function GameBoyAdvanceVideo() {
    ...
    <script>function MemoryProxy(owner, size, blockSize) {
        this.owner = owner;
        this.blocks = [];
    ...
    <script>function MemoryAligned16(size) {
    ...
    <script>function GameBoyAdvanceInterruptHandler() {
        this.inherit();
    ...
    <script>function GameBoyAdvanceKeypad() {
    ...
    <script>function SRAMSavedata(size) {
    ...
    <script>function GameBoyAdvanceGPIO(core, rom) {
        this.core = core;
        this.rom = rom;
    ...
    <script>function GameBoyAdvance() {
        this.LOG_ERROR = 1;
        this.LOG_WARN = 2;
        this.LOG_STUB = 4;
        this.LOG_INFO = 8;
    ...
    <script>function loadRom(url, callback) {
